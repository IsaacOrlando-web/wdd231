export const places = [
    {
      ...
      "description": "The unique pentagon-shaped main square of Coyhaique, featuring a monument to the region's pioneers, landscaped gardens, and artisan kiosks selling wool crafts and local foods. A social and cultural hub.",
      "image_url": "../images/places-imgs/plazaArmas.webp"
    },
    {
      "name": "Reserva Nacional Coyhaique",
      "address": "Ruta 240, 5 km north of Coyhaique",
      "description": "A 4,200-hectare nature reserve with trails through lenga forests, lagoons, and viewpoints like Cerro Cinchao. Popular for hiking, birdwatching, and snowshoeing in winter.",
      "image_url": "../images/places-imgs/ReservaNacional.webp"
    },
    {
      "name": "Museo Regional de Aysén",
      "address": "Av. Costanera s/n, Coyhaique",
      "description": "A museum documenting Aysén's history, from indigenous Tehuelche peoples to 20th-century settlers. Exhibits include farming tools, fossils, and a replica pioneer house.",
